...
//		conf := config.Parse(models.Config.QbotConfigFile)
//		//conf = config.Get()
//	} else {
//		conf = &config.Config{}
//	}
...
//	} else {
//		base.PostFormat = conf.Message.PostFormat
//	}
//	base.IgnoreInvalidCQCode = conf.Message.IgnoreInvalidCQCode
//	base.SplitURL = conf.Message.FixURL
//	base.ForceFragmented = conf.Message.ForceFragment
//	base.RemoveReplyAt = conf.Message.RemoveReplyAt
//	base.ExtraReplyData = conf.Message.ExtraReplyData
//	base.SkipMimeScan = conf.Message.SkipMimeScan
